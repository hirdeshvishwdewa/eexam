                                ...
                                <tr>
                                    <td valign="top" align="left" width="86%" >
                                        <div style="border: 2px #3D997A solid; border-radius: 10px; height:150px; padding:50px;">
                                            <div style="position:relative; border: 2px #3D997A solid; border-radius: 10px; padding:50px; width:250px;">
												<?php
													...
													&& in_array($extension, $allowedExts))
													  ...
													  if ($_FILES["file"]["error"] > 0)
													  ...
													  else
														{
														  ...
														  $sql="UPDATE users SET profilepic='$filename' WHERE username='$username'";
