...
if (session_start() && isset($_SESSION['examcode'])) {
	...
	$login="<div class=\"recentToppers\" style=\"margin-top:30px; width:100%;\">
		...
		<a href=\"registerUser.php\" class=\"submitButton\">
			Register Here!</a>
		";
		$display="<div id=\"indexPageContent\">
					<b class=\"recentToppers\" style=\"padding:5px;\">
						<img src=\"images/home.png\" style=\"height:25px;\" />
						Welcome to eExam</b>
		...
		$inbox="<a href=\"inbox.php?username=".$_SESSION['username']."\"class=\"link\"><div class=\"hori_list_tab\"><img src=\"images/inbox.png\" style=\"position:relative; margin-top:4px; height:15px;\"> Inbox</div></a>";
		$profile="<a href=\"student.php?username=".$_SESSION['username']."\"class=\"link\"><div class=\"hori_list_tab\"><img src=\"images/user.png\" style=\"position:relative; margin-top:4px; height:15px;\"> Profile</div></a>";
		$display="<div id=\"indexPageContent\">
		...
		if ($_SESSION['username']=="admin") {
            $studentdisplay="<div class=\"recentToppers\">
								<img src=\"images/search.png\" style=\"height:25px;\"/>
								Search a Student
							</div>
            ...
            $display="<div style=\"height:auto; width:95%; margin-left:30px;\">
                                            <div style=\"position: relative;\">
													<img src=\"images/question1.png\" style=\"\" align=\"middle\" />
						...
						";
						$examNote="<a href=\"editexamNote.php\" class=\"link\"><div class=\"hori_list_tab\"><img src=\"images/edit.png\" style=\"position:relative; margin-top:4px; height:16px;\"> Edit ExamNote</div></a>";
						$resultList="<a href=\"resultList.php\" class=\"link\"><div class=\"hori_list_tab\"><img src=\"images/result.png\" style=\"position:relative; margin-top:4px; height:17px;\"> Result List</div></a>";
						$questionList="<a href=\"questionList.php\" class=\"link\"><div class=\"hori_list_tab\"><img src=\"images/question.png\" style=\"position:relative; margin-top:4px; height:16px;\"> Question List</div></a>";
						$setPaper="<a href=\"setPaper.php\" class=\"link\"><div class=\"hori_list_tab\"><img src=\"images/set-paper.png\" style=\"position:relative; margin-top:4px; height:16px;\"> Set Paper</div></a>";
	} else {
                ...
                <tr <?php if (isset($_SESSION['pass']) && ($_SESSION['username']=="admin")) echo "onclick=\"flush_result1()\""; ?> >
                    <td colspan="2" >
                        <span class="hori_list">
                            <a href="index.php" class="link"><div class="hori_list_tab"><img src="images/home1.png" style="height:15px;" />Home</div></a>
							<?php if (isset($inbox)) echo $inbox; ?>
							<?php if (isset($profile)) echo $profile; ?>
                            <a href="ExamRules.php" class="link"><div class="hori_list_tab"><img src="images/exam-rules.png" style="height:15px;" /> Exam Rules</div></a>
							<?php if (isset($examNote) || isset($resultList) || isset($questionList) || isset($setPaper)) echo $examNote." ".$resultList." ".$questionList." ".$setPaper; ?>
                            <a href="about.php" class="link"><div class="hori_list_tab"><img src="images/about.png" style="height:15px;" /> About</div></a>
                        </span>
						<div style="height:20px; width:100%; margin-top:15px;"></div>
                    </td>
                </tr>
				<tr>
                                ...
                                <tr>
                                    <td>
										<?php if (isset($_SESSION["username"]) && isset($_SESSION["pass"]) && $_SESSION["username"]=="admin")
											echo "<div style=\"padding:5px; width: inherit; height: auto; border: 2px #64AD95 solid;\" onclick=\"flush_result1()\">
													...
													$sql="SELECT examid,examname,examcode,maxque,date,status,timelimit FROM exams WHERE semester='$semester' ORDER BY examid";
													...
													while($result=mysql_fetch_assoc($res)) {
															...
															echo "<tr><td><a class=\"inbox_hori\" href=\"ExamRules.php?examid=".$examid."\">
																			<div class=\"inbox_slabs\">
																				<b style=\"font-size:50px;\">".$category."</b><br />
																				Date of Quiz=<b>".$date."</b><br />
																				No. of Question=".$maxque."
																			</div>
																</a></td></tr>";
														}
													mysql_close($dbc);
